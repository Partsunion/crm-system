                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : 'text-text-tertiary hover:bg-[rgb(var(--admin-nav-overlay)/0.055)] hover:text-text-primary',
                    )}
                  >
                    {isActive && (
                      <span
                    ...
                    <span
                      className={cn(
                        ...
                        isActive ? 'bg-[rgb(var(--admin-nav-overlay)/0.10)] text-text-primary' : NAV_TONES[item.tone],
                      )}
                    >
